...
module.exports = (client, int) => {
    ...
    switch (int.customId) {
        case 'saveTrack': {
          if (!queue || !queue.playing) return int.reply({ content: `Nenhuma música está a tocar agora. ❌`, ephemeral: true, components: [] });
          ...
          .setTimestamp()
          .setFooter({ text: 'Comandos do Bot - by Az3nh4#0001 ❤️', iconURL: int.user.displayAvatarURL({ dynamic: true }) });
